...
public class BeerControllerTest {
    ...
    @Test
    void whenPATCHIsCalledToDecrementDiscountThenBadRequestIsReturned() throws Exception {
        QuantityDTO quantityDTO = QuantityDTO.builder()
                .quantity(15)
                .build();
        ...
        //when
        doThrow(BeerStockInferiorException.class).when(beerService).decrement(VALID_BEER_ID, quantityDTO.getQuantity());
    ...
    @Test
    void whenPATCHIsCalledToIncrementDiscountThenBadRequestIsReturned() throws Exception {
        QuantityDTO quantityDTO = QuantityDTO.builder()
                .quantity(20)
                .build();
